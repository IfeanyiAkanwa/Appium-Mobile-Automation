...
public class CorporateSimSwap extends TestBase {
    ...
    public void navigateToCorporateSimSwap(String dataEnv) throws Exception {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/pageTitle")));
    ...
    public void corporateSwapMsisdnValidation(String dataEnv) throws Exception {
        ...
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/radio_item_tm", "TM");
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/radio_item_child", "CHILD");
        ...
        getDriver().findElement(By.id("android:id/button1")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/radio_item_tm")));
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/radio_item_tm")).click();
        Thread.sleep(500);
        ...
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/swapCategory", "");
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(invalidFormat);
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/existingMsisdnField", lessMsisdn2);
        Thread.sleep(500);
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(invalidMsisdn);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(newMsisdn);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).sendKeys(newSerial);
        TestUtils.scrollDown();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(moreMsisdn);
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/existingMsisdnField", moreMsisdn.substring(0,11));
        Thread.sleep(500);
        TestUtils.testTitle("Confirm Existing MSISDN cannot take less than 11 digits (" + lessMsisdn1 + " and " + lessMsisdn2 + ")");
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(lessMsisdn1);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        Thread.sleep(500);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(lessMsisdn2);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/existingMsisdnField")).sendKeys(validMsisdn);
        Thread.sleep(500);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(invalidFormat);
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/newMsisdnField", lessMsisdn2);
        Thread.sleep(500);
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(invalidMsisdn);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(moreMsisdn);
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/newMsisdnField", moreMsisdn.substring(0,11));
        Thread.sleep(500);
        TestUtils.testTitle("Confirm New MSISDN cannot take less than 11 digits (" + lessMsisdn1 + " and " + lessMsisdn2 + ")");
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(lessMsisdn1);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        Thread.sleep(500);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(lessMsisdn2);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        TestUtils.assertSearchText("ID", "android:id/message", "Existing MSISDN: The MSISDN has an unrecognized National Destination Code. Please ensure the MSISDN starts with any of the following NDCs: 0701,0708,0802,0808,0812,0901,0902,0904,0907,0809,0817,0818,0908,0909,0705,0805,0807,0811,0815,0905,0915,0703,0706,0803,0806,0810,0813,0814,0816,0903,0906 and must be 11 digits");
        getDriver().findElement(By.id("android:id/button1")).click();
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(newMsisdn);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).sendKeys(moreSerial);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/simSerialField",moreSerial.substring(0,20));
        Thread.sleep(500);
        TestUtils.testTitle("Confirm Existing MSISDN cannot take less than 20 digits (" + lessSerial + ")");
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).sendKeys(lessSerial);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/simSerialField")).sendKeys(invalidFormatSerial);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnValidate")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        TestUtils.assertSearchText("ID","android:id/message","New SIM Serial: SIM Serial format is invalid. SIM Serial should be 19 numbers with 'F' at the end");
        getDriver().findElement(By.id("android:id/button1")).click();
        ...
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/sim_swap_typeTXT","SIM Swap Type*");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/swapCategory", "");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/existingMsisdnField",validMsisdn);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/newMsisdnField",newMsisdn);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/simSerialField",newSerial);
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/radio_item_child")).click();
        Thread.sleep(500);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/radio_item_child","CHILD");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/sim_swap_typeTXT","SIM Swap Type*");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/swapCategory", "");
        ...
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/newMsisdnField",newMsisdn);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/simSerialField",newSerial);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/childMsisdnField","Enter Child MSISDN*");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/childFirstNameField","Enter Child First Name*");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/childLastNameField","Enter Child Last Name*");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/rawSimCheckBox","Raw SIM");
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/radio_item_tm")).click();
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/rawSimCheckBox")));
        TestUtils.assertSearchText("ID", "com.sf.biocapture.activity.glo:id/rawSimCheckBox", "Raw SIM");
        ...
        Thread.sleep(500);
        if (!(getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).isEnabled())) {
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/rawSimCheckBox")).click(); // To disable Raw SIM Checkbox
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).clear();
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).sendKeys(newMsisdn);

        Thread.sleep(500);
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/btnValidate","Validate");
        if (getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/newMsisdnField")).isEnabled()) {
    ...
    public void verifyBiometrics(String dataEnv) throws Exception {
        ...
        getDriver().findElement(By.id("android:id/button1")).click();
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/btn_capture")));
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/btn_capture","Verify Biometrics");
        if (getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btn_capture")).isEnabled()) {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/btnNext")));
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/pageTitle","Corporate SIM Swap");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/btnValidate","Validate");
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btnNext")).click();
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        ...
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/nin","Supply NIN");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/nin_verification_title")));
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/nin_verification_title","NIN Verification");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/tv_portrait_image","Portrait Image");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/tv_user_data","User Data");
    ...
    public void fdnCheck(String dataEnv) throws Exception {
        ...
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        TestUtils.assertSearchText("XPATH","//android.widget.TextView[@text='Last Invoice Amount is empty']","Last Invoice Amount is empty");
        getDriver().findElement(By.id("android:id/button1")).click();
        Thread.sleep(500);
        TestUtils.scrollUp2();
        TestUtils.scrollUntilElementIsVisible("ID", "com.sf.biocapture.activity.glo:id/lastInvoiceAmt");
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/lastInvoiceAmt")).sendKeys(lastInvoiceAmount);

        // Last Invoice Date
        TestUtils.scrollUntilElementIsVisible("ID", "com.sf.biocapture.activity" + Id + ":id/lastInvoiceDate");
        getDriver().findElement(By.id("com.sf.biocapture.activity" + Id + ":id/lastInvoiceDate")).clear();
        TestUtils.scrollUntilElementIsVisible("ID","com.sf.biocapture.activity.glo:id/submit");
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/submit")).click();
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/alertTitle")));
        TestUtils.assertSearchText("XPATH","//android.widget.TextView[@text='Last Invoice Date is empty']","Last Invoice Date is empty");
        getDriver().findElement(By.id("android:id/button1")).click();
        Thread.sleep(500);
        TestUtils.scrollUp2();
        TestUtils.scrollUntilElementIsVisible("ID", "com.sf.biocapture.activity" + Id + ":id/lastInvoiceDate");
        getDriver().findElement(By.id("com.sf.biocapture.activity" + Id + ":id/lastInvoiceDate")).sendKeys(lastInvoiceDate);
        ...
        TestUtils.scrollUntilElementIsVisible("ID","com.sf.biocapture.activity.glo:id/check_box_affidavit");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/check_box_affidavit","Upload Affidavit");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/check_box_affidavit")));
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/check_box_affidavit")).click();
        Thread.sleep(500);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/submit")).click();
        Thread.sleep(500);
        ...
        TestUtils.assertSearchText("XPATH","//android.widget.TextView[@text='Optional Parameter - At least 3 must pass']","Optional Parameter - At least 3 must pass");
        TestUtils.scrollDown();
        ...
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/summary","Upload all necessary Documents.");
        TestUtils.assertSearchText("ID","com.sf.biocapture.activity.glo:id/finger_name","Add Documents");
        ...
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/finger_name")).click();
        Thread.sleep(500);
        ...
        Thread.sleep(500);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/captureButton")));
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/captureButton")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/ok")));
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/ok")).click();
        Thread.sleep(500);
    ...
    public void swapRequest(String dataEnv) throws Exception {
        ...
        getDriver().findElement(By.id("android:id/button1"));
        Thread.sleep(500);
    ...
    public static void verifyBioMetricsTest() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity.glo:id/btn_capture")));
        Thread.sleep(2000);
        getDriver().findElement(By.id("com.sf.biocapture.activity.glo:id/btn_capture")).click();
