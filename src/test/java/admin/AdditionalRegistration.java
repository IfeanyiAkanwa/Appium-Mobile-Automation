...
public class AdditionalRegistration extends TestBase {
	...
	@Parameters({ "dataEnv"})
    @Test
    public void additionalRegPrivilegedUseCase(String dataEnv) throws Exception {
	...
	public void MsisdnCategory(String dataEnv) throws Exception {
		...
		// Selecting Msisdn Category drop down for Primary Page and the first item should be mobile
		TestUtils.testTitle("Selecting Msisdn Category drop down for Primary Page and the first item should be mobile");
		...
		// Selecting Msisdn Category drop down for validation Page and the first item should be mobile
		TestUtils.testTitle("Selecting Msisdn Category for validation Page drop down and the first item should be mobile");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/next_button")).click();
		...
		//Confirm MSISDN does not get more than 11 digits for verification
		String moreCharacters=valid_Msisdn+"1234";
		TestUtils.testTitle("Confirm MSISDN does not get more than 11 digits ("+moreCharacters+") for verification");
		...
		TestUtils.testTitle("Validating a valid MSISDN on new registration ("+valid_Msisdn+")");
		getDriver().findElement(By.xpath("//android.widget.ImageButton[@content-desc='Navigate up']")).click();
		getDriver().findElement(By.id("android:id/button1")).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity." + Id + ":id/typeofreg")));
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/typeofreg")).click();
		...
		//Confirm MSISDN does not get more than 11 digits for new registration
		String priCharacters=pri_valid_Msisdn+"1234";
		TestUtils.testTitle("Confirm MSISDN does not get more than 11 digits ("+priCharacters+") for verification");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).sendKeys(priCharacters);
		TestUtils.assertSearchText("ID", "com.sf.biocapture.activity." + Id + ":id/msisdnField", pri_valid_Msisdn);
	...
	public void additionalRegistration(String dataEnv) throws Exception {
		...
		TestUtils.testTitle("Confirming wrong combination of invalid serial: (" + WrongInvalid_simSerial + ") ");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		TestUtils.testTitle("Proceed after supplying invalid msisdn: (" + invalid_number + ") and valid sim serial: (" + pri_valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/submit_button")).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("android:id/button1")));
		TestUtils.assertSearchText("ID", "android:id/message", "Unknown msisdn");
		getDriver().findElement(By.id("android:id/button1")).click();


		// Proceed after supplying valid msisdn and sim serial for validation
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + pri_valid_Msisdn + ") and valid sim serial: (" + pri_valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(pri_valid_simSerial);
		...
		// NEXT after supplying invalid msisdn and sim serial for validation
		TestUtils.testTitle("NEXT after supplying invalid msisdn: (" + invalid_Msisdn + ") and invalid sim serial: (" + invalid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(pri_valid_simSerial);
		...
		// Proceed after supplying valid msisdn and sim serial for validation
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + valid_Msisdn + ") and valid sim serial: (" + valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).sendKeys(valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/simSerialField")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/simSerialField")).sendKeys(valid_simSerial);
		...
		String noValid=getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).getText();
		TestUtils.testTitle("To check user is unable to Add record Successfully after maximum (" + noValid + ") validation");
		if(noValid!="+0"){
		...
		String noValid2=getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/msisdnField")).getText();
		if(noValid2=="+0"){
			TestUtils.testTitle("To check user is unable to Add record Successfully below maximum (" + noValid2 + ") validation");
			getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/viewSerialButton")).getText();
	...
	@Parameters({ "dataEnv"})
	@Test
	public void inCompleteBioData(String dataEnv) throws Exception {
		...
		/*Thread.sleep(50000);
		// Proceed after supplying valid msisdn and sim serial with incomplete biometrics
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + company_Msisdn + ") and valid sim serial: (" + company_serial + ") with incomplete biometrics");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
	...
	public void additionalRegTypePrivilege(String dataEnv) throws Exception {
		...
		// Proceed after supplying valid msisdn and sim serial with individual reg type
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + individual_Msisdn + ") and valid sim serial: (" + individual_serial + ") with incomplete biometrics");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/submit_button")).click();
		/*wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("android:id/button1")));
		TestUtils.assertSearchText("ID", "android:id/message", "Sorry, you cannot proceed with this registration because you do not have the privilege to perform corporate registration");*/
	...
	@Parameters({ "dataEnv"})
	@Test
	public void NCDrule(String dataEnv) throws Exception {
		...
		// Proceed after supplying invalid number and sim serial
		TestUtils.testTitle("Proceed after supplying invalid number: (" + invalid_Msisdn + ") and invalid sim serial: (" + valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		// Proceed after supplying valid number and sim serial
		TestUtils.testTitle("Proceed after supplying valid number: (" + pri_valid_Msisdn + ") and invalid sim serial: (" + pri_valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(pri_valid_simSerial);
		...
		// Proceed after supplying invalid number and sim serial then valid number with sim serial
		TestUtils.testTitle("Proceed after supplying invalid number: (" + invalid_Msisdn + ") and valid sim serial: (" + valid_simSerial + ") valid number: (" + pri_valid_Msisdn + ") and invalid sim serial: (" + valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(invalid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(valid_simSerial);
		...
		//Run 4 steps from testing on invalid number and serial with valid number and serial
		TestUtils.testTitle("Run 4 steps from testing on invalid number and serial with valid number and serial");
		for (int i=0; i <4; i++){
			int j = i+1;
			TestUtils.testTitle("Run 4 steps (STEP["+j+"])");
			//Go back
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.sf.biocapture.activity." + Id + ":id/summary_ok_button")));
			getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/summary_ok_button")).click();
