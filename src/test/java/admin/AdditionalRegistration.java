...
public class AdditionalRegistration extends TestBase {
	...
	public void MsisdnCategory(String dataEnv) throws Exception {
		...
		TestUtils.testTitle("Select MSISDN category drop down for primary page and the first item should be mobile");
		...
		TestUtils.testTitle("Select MSISDN category for validation page drop down and the first item should be mobile");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/next_button")).click();
		...
		TestUtils.testTitle("Confirm MSISDN(Mobile) does not get more than 11 digits ("+moreCharacters+") for verification");
		...
		TestUtils.testTitle("Confirm MSISDN(Fixed) does not get more than 9 digits ("+priCharacters+") for verification");
		getDriver().findElement(By.id("android:id/text1")).click();
	...
	public void additionalRegistration(String dataEnv) throws Exception {
		...
		TestUtils.testTitle("Proceed after supplying invalid msisdn: (" + invalid_Msisdn + ") and valid sim serial: (" + pri_valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		TestUtils.testTitle("Proceed to next after supplying invalid msisdn: (" + invalid_Msisdn + ") and invalid sim serial: (" + invalid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(pri_valid_simSerial);
	...
	public void additionalRegTypePrivilege(String dataEnv) throws Exception {
		...
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + individual_Msisdn + ") and valid sim serial: (" + individual_serial + ") with individual reg type");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		TestUtils.testTitle("Proceed after supplying valid msisdn: (" + company_Msisdn + ") and valid sim serial: (" + company_serial + ") with company reg type");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
	...
	public void ndcRule(String dataEnv) throws Exception {
		...
		TestUtils.testTitle("Proceed after supplying invalid number: (" + invalid_number + ") and invalid sim serial: (" + valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		...
		TestUtils.testTitle("Proceed after supplying valid number: (" + pri_valid_Msisdn + ") and valid sim serial: (" + pri_valid_simSerial + ") for validation");
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_msisdn_field")).sendKeys(pri_valid_Msisdn);
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).clear();
		getDriver().findElement(By.id("com.sf.biocapture.activity." + Id + ":id/primary_serial_field")).sendKeys(pri_valid_simSerial);
		...
		TestUtils.testTitle("To check user gets error after supplying {invalid number: (" + invalid_number + ") and valid sim serial: (" + valid_simSerial + ")} and trying {valid number: (" + pri_valid_Msisdn + ") and invalid sim serial: (" + valid_simSerial + ") for validation}");
